...
2. What are the two options of ram, disk and vcpu configuration you can have in running codespaces . ***(1 mark)*** from 2 cores, 8 GB RAM, and 32 GB storage, up to 32 cores, 64 GB RAM, and 128 GB storage.
3. Why must we commit and sync our current work on source control? ***(1 mark)*** Ensures version control and collaboration by tracking changes, facilitating backup, supporting continuous integration, and enabling code review.
...
overlay         32847680 13637084  17516500  44% /
tmpfs              65536        0     65536   0% /dev
shm                65536        8     65528   1% /dev/shm
/dev/root       30298176 23168196   7113596  77% /vscode
/dev/loop5      32847680 13637084  17516500  44% /workspaces
...
total 32
 4 drwxrwxrwx+ 4 codespace root  4096 Jan 31 12:32 .
 4 drwxr-xrwx+ 5 codespace root  4096 Jan 31 12:32 ..
 4 drwxrwxrwx+ 9 codespace root  4096 Jan 31 12:54 .git
16 -rw-rw-rw-  1 codespace root 15556 Jan 31 13:02 README.md
 4 drwxrwxrwx+ 2 codespace root  4096 Jan 31 12:32 images
...
No. Because containers prioritize lightweight and stateless characteristics for portability and efficiency. The default behavior is non-persistence to enable quick startup and resource efficiency. Persistent storage options like volumes or bind mounts are available when needed.
...
1. What is the permission of folder /usr/local/apache/htdocs and what user and group owns the folder? . ***(2 mark)*** Apache
